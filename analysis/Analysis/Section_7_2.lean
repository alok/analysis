...
/-- Proposition 7.2.14 (a) (Series laws) / Exercise 7.2.5. The {lit}``convergesTo`` form can be more convenient for applications. -/
...
/-- Proposition 7.2.14 (b) (Series laws) / Exercise 7.2.5. The {lit}``convergesTo`` form can be more convenient for applications. -/
