...
open Real in
/-- Proposition A.6.2. The proof below is somewhat non-idiomatic for Lean, but illustrates how to implement a "let {lit}``ε`` be a quantity to be chosen later" type of proof. -/
