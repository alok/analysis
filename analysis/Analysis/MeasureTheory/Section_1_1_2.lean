...
/-- Definition 1.1.4. We intend these concepts to only be applied for bounded sets {lit}``E``, but
it is convenient to permit {lit}``E`` to be unbounded for the purposes of making the definitions.
-/
