...
I have attempted to make the translation as faithful a paraphrase as possible of the
...
theorem DifferentiableOn.of_F_11_9_2 {x:ℝ} (hx: ¬ ∃ r:ℚ, x = r) (hx': x ∈ Set.Icc 0 1) :
  ...
  refine ⟨ContinuousLinearMap.toSpanSingleton ℝ (f_9_8_5 x), ?_⟩
  simpa [F_11_9_2] using this
